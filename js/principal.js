    ...
    var municipalidades_cr = L.geoJson(geodata, {
        ...
        onEachFeature: function (feature, layer) {
            var popupText = "<strong>Municipalidad:</strong> " + feature.properties.municipalidad +
                            "<br><strong>Región:</strong> " + feature.properties.region +
    ...
    var municipalidades_gr = L.geoJson(geodata, {
        pointToLayer: function (feature, latlng) {
            var leafIcon = new L.Icon({
                ...
                iconSize: [30, 30], // Set a uniform size without incline or shadow
                iconAnchor: [15, 15], // Adjust icon anchor to be centered
                popupAnchor: [-1, -15] // Adjust popup anchor to open above the icon
            });
